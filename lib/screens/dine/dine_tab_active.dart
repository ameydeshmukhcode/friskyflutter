                ...
                SingleChildScrollView(
                  child: Column(
                    children: <Widget>[
                      ...
                      ordersProvider.isOrderActive
                          ? LastOrdersWidget(Session: Session)
                          : StartOrderWidget(
                              Session: Session,
                            ),
                      Container(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          FAText("Your bill so far....", 18,
                              FriskyColor.colorPrimary),
                          FAText("\u20B9" + ordersProvider.billAmount, 24,
                              FriskyColor.colorTextDark),
                          FAText("(Click here to View Details)", 10,
        ...
        children: <Widget>[
          Flexible(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: <Widget>[
                FAText("Last Ordered Item", 20, FriskyColor.colorPrimary),
                Flexible(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FAText("Order More", 18, Colors.white),
                        ),
                      ],
                    ),
                  ),
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: <Widget>[
                      FAText("Start ordering", 24, Colors.white),
                      Container(
                        padding: EdgeInsets.only(bottom: 8),
                      ),
                      FAText("(tap to access menu)", 20, Colors.white),
                    ],
                  ),
                ],
              )),
